...
\extra{meer uitleg in het voorbeeld pagina 47, dit deel her- en uitschrijven.}
\end{vb}
...
\begin{bpr}
  ...
  \begin{proof}
    ...
    \item Stel dat $f''(a)$ strikt positief is.\\
      ...
      Uit de middelwaardestelling van Taylor volgt nu dat er een $c$ strikt tussen $a$ en $a+h$ bestaat als volgt  wanneer $a+h$ in $I$ zit:\stref{st:middelwaardestelling-taylor}
      ...
      \extra{beter uitschrijven, tweede deel zelf vinden zonder naar het eerste te kijken.}
