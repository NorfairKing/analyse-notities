...
\begin{st}
  \stiekem{Augustus 2014}
  Zij $X,d$ een metrische ruimte en $a\in X$.
  De sluiting $C_{a}(X)$ voor de $d_{\infty}$ metriek is $C_{a}(X)$ zelf want $C_{a}(X)$ is gesloten.
  \begin{proof}

\iffalse
    \noindent
    $C_{a}(X)$ is zelf niet gesloten:\\
      Kies $a=0$
...
\fi
      ...
      $f$ is bovendien continu want $(f_{n})_{n}$ convergeert volgens $d_{\infty}$ (dus continu) naar $f$.\stref{st:uniform-convergente-rij-functies-dan-asa-continu}
  \end{proof}
\end{st}
