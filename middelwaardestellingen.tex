  ...
  \begin{proof}
    ...
    \item $a\in \mathbb{R}$, $\lim_{x\rightarrow a}f(x) = \lim_{x\rightarrow a}g(x) = 0$ en $\lim_{x\rightarrow a}\frac{f'(x)}{g'(x)} = L \in \mathbb{R}$.\\
      ...
      \item 
        ...
        Omdat $\lim_{y \rightarrow a}g(y)$ nul is, maar $g(x)$ nergens nul, geldt het volgende:\prref{pr:rekenregels-limieten-van-functies}
        ...
        Omdat $\lim_{y\rightarrow a}(y)$ en $\lim_{y \rightarrow a}g(y)$ beide nul zijn, maar $g(x)$ nergens nul is, geldt ook het volgende:\prref{pr:rekenregels-limieten-van-functies}
        ...
        \]
      \item 
        Volgens de middelwaardestelling van Cauchy bestaat er een $c\in \interval[open]{x}{y}$ als volgt:\stref{st:middelwaardestelling-cauchy}
      ...
      \item 
        ...
        \]
        \question{hoe zit het met die voorlaatste gelijkheid?!}
      \end{itemize}
    \item $a=+\infty$, $\lim_{x \rightarrow a}g(x) = +\infty$, $\lim_{x \rightarrow a}\frac{f'(x)}{g'(x)} = -\infty$
      ...
      \item 
        ...
        \question{kleiner dan 3/2, niet groter dan 1/2}
        ...
        \question{wat? dit klopt niet echt he...}
      \item 
      ...
      \item 
        ...
        \question{wat? geldt die ongelijkheid wel?}
      \end{itemize}
    \end{itemize}
