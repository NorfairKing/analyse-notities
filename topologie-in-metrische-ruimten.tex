...
\begin{de}
  Zij $X,d$ een metrische ruimte en $A \subseteq X$.
  We noemen $A$ \term{totaal begrensd} als en slechts als we voor $\epsilon \in \mathbb{R}_{0}^{+}$ de verzameling $A$ kunnen overdekken met een eindig aanatal open bollen met straal $\epsilon$.
