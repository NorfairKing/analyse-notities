...
\begin{de}
  ...
  We noemen een deelverzameling $V$ van $X$ \term{Cauchycompact} als elke rij in $V$ een Cauchy-deelrij heeft.
\end{de}
...
\begin{st}
  Zij $X,d$ een metrische ruimte en $A \subseteq X$, dan is $A$ Cauchycompact als en slechts $A$ totaal begrensd is.
...
\begin{bst}
  ...
  Als $A$ rijcompact is, dan is $A$ gesloten en begrensd.
...
\begin{bst}
  ...
  \begin{proof}
    ...
    \item $\Leftarrow$\\
      ...
      Als de verzameling $\{x_{n}\mid n\in \mathbb{N}\}$ eindig is, bevat $(x_{n})_{n}$ zeker een convergente deelrij.\stref{st:rij-met-eindig-aantal-waarden-convergente-deelrij}
