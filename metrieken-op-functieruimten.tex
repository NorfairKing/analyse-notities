  ...
  \begin{proof}
    ...
    \item $d'(f,g)$ is nul als en slechts als $f$ en $g$ gelijk zijn:
      ...
      \item $\Leftarrow$:\\
        ...
        \TODO{meer uitleg. waarom moeten ze gelijk zijn?}
      \end{itemize}
...
\begin{vb}
  ...
  \begin{proof}
    ...
    We weten dus al dat de rij $(f'_{n})_{n}$ uniform convergeert naar een continue $f'$.\vbref{vb:continue-functies-volledig}
    ...
    \[
      ...
      \end{cases}
    \]
    \TODO{meer uitleg, dit is het idee:}
    \begin{align*}
      |f(x)-g(x)|
